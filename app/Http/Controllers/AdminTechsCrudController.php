...
class AdminTechsCrudController extends Controller
{
    ...
    public function add()
    {
        return view('admin.addUser')->with(['route'=>'admin.createTechnician', 'posts'=> ['Technicien Hardware','Technicien Software','Technicien Informatique','Ingenieur Informatiqu']]);
    }
    ...
    {
        $tech = Technician::where('user_id', $id)->firts();
