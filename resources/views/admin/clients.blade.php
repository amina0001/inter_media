...
@section('content')
                ...
                @foreach ($clients as $key=>$client)
                    <li >
                        <div>
                            ...
                            <a class="btn  consulter" data-toggle="modal" data-target="#myModal{{ $key }}">Consulter</a>
    ...
    @foreach ($clients as $key=>$client)
        <div class="modal video-modal fade" id="myModal{{ $key }}" tabindex="-1" role="dialog" aria-labelledby="myModal{{ $key }}">
                        ...
                        <div class="w3_login_module">
                            ...
                            <div class="form">
                                <form method="POST" action="{{ route('admin.updateClient', $client->user_id) }}" enctype="multipart/form-data">
                                    ...
                                    <input type="text" name="nom" placeholder="Nom" value="{{ $client->details->last_name }}">
                                    <input type="text" name="description" placeholder="Prénom" value="{{ $client->details->first_name }}">
                                    <input type="text" name="description" placeholder="Email" value="{{ $client->details->email }}">
                                    <input type="text" name="description" placeholder="Adresse" value="{{ $client->details->address }}">
                                    <input type="text" name="description" placeholder="Phone" value="{{ $client->details->phone }}">
