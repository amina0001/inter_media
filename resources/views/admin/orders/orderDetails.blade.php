    ...
    <div class="women_main">
        ...
        <div>
            <div class=" form-mod ">
                ...
                @if (!is_null($order))
                    <input type="text" name="accessories" placeholder="Accessoires" required="" value="{{ $order->breakdown->device->accessories }}">
                @else
                    <input type="text" name="accessories" placeholder="Accessoires" required="">
                @endif                
                <select name="nature" >
