                ...
                @foreach ($promotions as $key=>$promotion)
                    <li >
                        <div>
                           ...
                           <a id="login" href="#" class="btn consulter" data-toggle="modal" data-target="#myModal{{ $key }}">consulter</a>
                                    ...
                                    <div class="module form-module">
                                        ...
                                        <div class="form ">
                                            <form method="POST" action="{{ route('admin.promotions.update', $promotion->id) }}" enctype="multipart/form-data">
                                                ...
                                                <img src="/storage/uploads/promotions/2.jpg" style="width: 70%;height: 70%;margin-left: 10%">
